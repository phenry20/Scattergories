...
var KTApp = (function () {
    ...
    return {
        ...
        progress: function (t, e) {
            ...
            KTApp.unprogress(t), KTUtil.attr(t, "disabled", !0), $(t).addClass(i), $(t).data("progress-classes", i);
        },
    ...
    if (n) {
        var o = { toggleSpeed: 400, sticky: { releseOnReverse: !1, offset: 300, zIndex: 101 } },
            l = {
                ...
                onScrollSticky: function (t) {
                    ...
                    if (!isNaN(e)) {
                        ...
                        n >= e && !1 === KTUtil.hasClass(i, "card-sticky-on")
                            ? (l.eventTrigger("stickyOn"), KTUtil.addClass(i, "card-sticky-on"), l.updateSticky())
                            : 1.5 * n <= e &&
                              KTUtil.hasClass(i, "card-sticky-on") &&
                              (l.eventTrigger("stickyOff"), KTUtil.removeClass(i, "card-sticky-on"), l.resetSticky());
                    }
                },
                ...
                toggle: function () {
                    KTUtil.hasClass(n, "card-collapse") || KTUtil.hasClass(n, "card-collapsed")
                        ? l.expand()
                        : l.collapse();
                },
                collapse: function () {
...
var KTCookie = {
    ...
    setCookie: function (t, e, a) {
        a || (a = {}),
            (a = Object.assign({}, { path: "/" }, a)).expires instanceof Date && (a.expires = a.expires.toUTCString());
            ...
            l = {
                ...
                build: function () {
                    ...
                    window.addEventListener("scroll", function () {
                        var n,
                            o = 0;
                        (KTUtil.isBreakpointDown("lg") && !1 === a.options.offset.tabletAndMobile) ||
                            (KTUtil.isBreakpointUp("lg") && !1 === a.options.offset.desktop) ||
                            (KTUtil.isBreakpointUp("lg")
                                ? (o = a.options.offset.desktop)
                                : KTUtil.isBreakpointDown("lg") && (o = a.options.offset.tabletAndMobile),
                            (n = KTUtil.getScrollTop()),
                            (KTUtil.isBreakpointDown("lg") && a.options.releseOnReverse.tabletAndMobile) ||
            ...
            r = {
                construct: function (t) {
                    return (
                        KTUtil.data(i).has("menu")
                            ...
                            : (r.init(t), r.reset(), r.build(), KTUtil.data(i).set("menu", a)),
                        a
                    );
                },
                init: function (t) {
                ...
                getSubmenuMode: function (t) {
                    return KTUtil.isBreakpointUp("lg")
                        ? t && KTUtil.hasAttr(t, "data-menu-toggle") && "hover" == KTUtil.attr(t, "data-menu-toggle")
                            ? "dropdown"
                        ...
                        : !(!KTUtil.isBreakpointDown("md") || !KTUtil.isset(a.options.submenu, "mobile")) &&
                    ...
                    if ("accordion" !== r.getSubmenuMode(this)) {
                        ...
                        !1 !== r.eventTrigger("submenuToggle", this, t) &&
                            ...
                            (!1 === KTUtil.hasClass(e, "menu-item-hover")
                                ? (KTUtil.addClass(e, "menu-item-open-dropdown"), r.showSubmenuDropdown(e))
                                : (KTUtil.removeClass(e, "menu-item-open-dropdown"), r.hideSubmenuDropdown(e, !0)),
                            t.preventDefault());
                    }
                },
                ...
                hideSubmenuDropdown: function (t, e) {
                    e && (KTUtil.removeClass(t, "menu-item-hover"), KTUtil.removeClass(t, "menu-item-active-tab")),
                ...
                showSubmenuDropdown: function (t) {
                    ...
                    s &&
                        ...
                        s && !0 === KTUtil.isOffscreen(s, "left", 15)
                            ? (KTUtil.removeClass(s, "menu-submenu-left"), KTUtil.addClass(s, "menu-submenu-right"))
                            : s &&
                              !0 === KTUtil.isOffscreen(s, "right", 15) &&
                              (KTUtil.removeClass(s, "menu-submenu-right"), KTUtil.addClass(s, "menu-submenu-left")),
                        t.getAttribute("data-menu-toggle-class") &&
                        ...
                        if ("string" == typeof a.options.toggleBy)
                            ...
                            if (a.options.toggleBy[0].target)
                                for (var t in a.options.toggleBy)
                                    KTUtil.addEvent(KTUtil.getById(a.options.toggleBy[t].target), "click", function (
                                        t
                                    ) {
                                        t.preventDefault(), (a.target = this), l.toggle();
                                    });
                            ...
                            a.options.toggleBy &&
                                ...
                                KTUtil.addEvent(KTUtil.getById(a.options.toggleBy.target), "click", function (t) {
                                    t.preventDefault(), (a.target = this), l.toggle();
                                });
            ...
            l = {
                ...
                handle: function () {
                    KTUtil.getScrollTop() > a.options.offset
                        ? !1 === i.hasAttribute("data-scrolltop") && i.setAttribute("data-scrolltop", "on")
                        : !0 === i.hasAttribute("data-scrolltop") && i.removeAttribute("data-scrolltop");
                },
                scroll: function (t) {
        ...
        for (var t = 0, e = ["webkit", "moz"], a = 0; a < e.length && !window.requestAnimationFrame; ++a)
            (window.requestAnimationFrame = window[e[a] + "RequestAnimationFrame"]),
                (window.cancelAnimationFrame =
                    window[e[a] + "CancelAnimationFrame"] || window[e[a] + "CancelRequestAnimationFrame"]);
    ...
    return {
        ...
        getHighestZindex: function (t) {
            for (var e, a; t && t !== document; ) {
                if (
                    ("absolute" === (e = KTUtil.css(t, "position")) || "relative" === e || "fixed" === e) &&
        ...
        deepExtend: function (t) {
            ...
            for (var e = 1; e < arguments.length; e++) {
                ...
                if (a)
                    for (var n in a)
                        a.hasOwnProperty(n) &&
                            ("object" == typeof a[n] ? (t[n] = KTUtil.deepExtend(t[n], a[n])) : (t[n] = a[n]));
            }
            return t;
        },
        extend: function (t) {
                ...
                set: function (e, a) {
                    t &&
                        (void 0 === t.customDataTag &&
                            (window.KTUtilElementDataStoreID++, (t.customDataTag = window.KTUtilElementDataStoreID)),
        ...
        one: function (t, e, a) {
            t.addEventListener(e, function e(n) {
                return (
                    n.target && n.target.removeEventListener && n.target.removeEventListener(n.type, e),
        ...
        numberString: function (t) {
            for (
                var e = (t += "").split("."), a = e[0], n = e.length > 1 ? "." + e[1] : "", i = /(\d+)(\d{3})/;
                i.test(a);
        ...
        scrollInit: function (t, e) {
            ...
            function a() {
                ...
                if (
                    ...
                    if (
                        ((n = parseInt(n)),
                        (e.mobileNativeScroll || e.disableForMobile) && KTUtil.isBreakpointDown("lg"))
                    )
                    ...
                    else if ((n > 0 && KTUtil.css(t, "height", n + "px"), e.desktopNativeScroll))
        ...
        scrollDestroy: function (t, e) {
            ...
            a && (a.destroy(), (a = KTUtil.data(t).remove("ps"))),
                t && e && (t.style.setProperty("overflow", ""), t.style.setProperty("height", ""));
        },
        ...
        btnWait: function (t, e, a, n = !0) {
            if (
                t &&
                (n && KTUtil.attr(t, "disabled", !0), e && (KTUtil.addClass(t, e), KTUtil.attr(t, "wait-class", e)), a)
            ) {
                var i = KTUtil.find(t, ".btn-caption");
                i
                    ? (KTUtil.data(i).set("caption", KTUtil.getHTML(i)), KTUtil.setHTML(i, a))
                    : (KTUtil.data(t).set("caption", KTUtil.getHTML(t)), KTUtil.setHTML(t, a));
            }
        },
        btnRelease: function (t) {
            if (t) {
                ...
                e && KTUtil.data(e).has("caption")
                    ...
                    : KTUtil.data(t).has("caption") && KTUtil.setHTML(t, KTUtil.data(t).get("caption"));
            }
        },
                ...
                goTo: function (t, e) {
                    if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
                        ...
                        if (
                            ...
                            !0 === e &&
                                (n = t > a.currentStep ? o.eventTrigger("beforeNext") : o.eventTrigger("beforePrev")),
                            !0 !== a.stopped)
                        )
                            return (
                                !1 !== n &&
                ...
                var l = {
                        ...
                        null === e.data.source && (l.extractTable(), (n = !0)),
                            ...
                            t.each(l.getOption("extensions"), function (e, a) {
                                "function" == typeof t.fn.KTDatatable[e] &&
                                    ("object" != typeof a && (a = t.extend({}, a)), new t.fn.KTDatatable[e](o, a));
                            }),
                            l.spinnerCallback(!0),
                            ("remote" !== e.data.type && "local" !== e.data.type) ||
                                ...
                                "local" === e.data.type &&
                                    ...
                                    (o.dataSet = o.originalDataSet = l.dataMapCallback(e.data.source)),
                                l.dataRender()),
                            n && (t(o.tableHead).find("tr").remove(), t(o.tableFoot).find("tr").remove()),
                            l.setHeadTitle(),
                    ...
                    layoutUpdate: function () {
                        l.setupSubDatatable.call(),
                            ...
                            l.isInit ||
                                (l.dropdownFix(),
                                t(o).trigger("datatable-on-init", { table: t(o.wrap).attr("id"), options: i }),
                                (l.isInit = !0)),
                            t(o).trigger("datatable-on-layout-updated", { table: t(o.wrap).attr("id") });
                    },
                    dropdownFix: function () {
                        var e;
                        t("body")
                            .on("show.bs.dropdown", ".datatable .datatable-body", function (a) {
                    ...
                    fullRender: function () {
                        t(o.tableHead).empty(),
                            l.setHeadTitle(),
                            l.getOption("layout.footer") && (t(o.tableFoot).empty(), l.setHeadTitle(o.tableFoot)),
                            l.spinnerCallback(!0),
                    ...
                    setupBaseDOM: function () {
                        (o.initialDatatable = t(o).clone()),
                            "TABLE" === t(o).prop("tagName")
                                ? ((o.table = t(o).removeClass("datatable").addClass("datatable-table")),
                            ...
                            void 0 === t(o).attr("id") &&
                                (l.setOption("data.saveState", !1), t(o.table).attr("id", a.getUniqueID("datatable-"))),
                    ...
                    adjustCellsHeight: function () {
                        t.each(t(o.table).children(), function (e, a) {
                            for (
                                var n = t(a).find(".datatable-row").first().parent().find(".datatable-row").length,
                                    i = 1;
                                i <= n;
                                i++
                            ) {
                    ...
                    setHeadTitle: function (e) {
                        ...
                        void 0 === r && ((r = document.createElement("tr")), e.appendChild(r)),
                            t.each(n, function (e, n) {
                                var i = s[e];
                                if (
                                    (void 0 === i && ((i = document.createElement("th")), r.appendChild(i)),
                                    void 0 !== n.title &&
                                        ((i.innerHTML = n.title),
                    ...
                    dataRender: function (e) {
                        ...
                        var a = function () {
                            ...
                            n = function (e) {
                                var n = function (e, a) {
                                    t(e.pager).hasClass("datatable-paging-loaded") || (t(e.pager).remove(), e.init(a)),
                                        t(e.pager)
                                            .off()
                            ...
                            (t.each(o.dataSet, function (n, r) {
                                ...
                                for (var p = 0; p < u; p += 1) {
                                    var f = i.columns[p],
                                        g = [];
                                    if (
                                        (l.getObject("sort.field", e) === f.field && g.push("datatable-cell-sorted"),
                                        void 0 !== f.textAlign)
                                    ) {
                    ...
                    getData: function () {
                        ...
                        if (("local" === i.data.type && (e.url = i.data.source), "remote" === i.data.type)) {
                            ...
                            l.getOption("data.serverPaging") || delete a.pagination,
                                ...
                                "string" != typeof (e = t.extend({}, e, l.getOption("data.source.read"))).url &&
                            ...
                            populate: function () {
                                ...
                                (i.pagerLayout.pagination = n),
                                    t("<li/>")
                                        .append(
                                            t("<a/>")
                                                .attr("title", a.first)
                                                .addClass("datatable-pager-link datatable-pager-link-first")
                                    ...
                                    t("<li/>")
                                        .append(
                                            t("<a/>")
                                                .attr("title", a.prev)
                                                .addClass("datatable-pager-link datatable-pager-link-prev")
                                    ...
                                    t("<li/>")
                                        .append(
                                            t("<a/>")
                                                .attr("title", a.more)
                                                .addClass("datatable-pager-link datatable-pager-link-more-prev")
                                ...
                                for (var c = d; c < (s || 1); c++) {
                                    ...
                                    t("<li/>")
                                        .append(
                                            t("<a/>")
                                                .addClass("datatable-pager-link datatable-pager-link-number")
                                                .text(u)
                                                .attr("data-page", u)
                                                .attr("title", u)
                                                .on("click", i.gotoPage)
                                ...
                                t("<li/>")
                                    .append(
                                        t("<a/>")
                                            .attr("title", a.more)
                                            .addClass("datatable-pager-link datatable-pager-link-more-next")
                                            .html(t("<i/>").addClass(e.more))
                                            .on("click", i.gotoMorePage)
                                    )
                                    .appendTo(n),
                                    t("<li/>")
                                        .append(
                                            t("<a/>")
                                                .attr("title", a.next)
                                                .addClass("datatable-pager-link datatable-pager-link-next")
                                    ...
                                    t("<li/>")
                                        .append(
                                            t("<a/>")
                                                .attr("title", a.last)
                                                .addClass("datatable-pager-link datatable-pager-link-last")
                                ...
                                0 == f.length && (f = [5, 10, 20, 30, 50, 100]),
                                    ...
                                    t(o).ready(function () {
                                        t(".selectpicker")
                                            ...
                                            .attr(
                                                "title",
                                                l.getOption("translate.toolbar.pagination.items.default.select")
                                            );
                                    }),
                                    i.paste();
                            },
                            paste: function () {
                                t.each(t.unique(l.getOption("toolbar.placement")), function (e, a) {
                                    "bottom" === a && t(i.pager).clone(!0).insertAfter(o.table),
                                        "top" === a &&
                                            t(i.pager).clone(!0).addClass("datatable-pager-top").insertBefore(o.table);
                                });
                            },
                                ...
                                t(o)
                                    ...
                                    .on(i.paginateEvent, function (e, a) {
                                        ...
                                        t(n)
                                            ...
                                            t(n)
                                                .find('.datatable-pager-link-number[data-page="' + a.page + '"]')
                            ...
                            paginationUpdate: function () {
                                ...
                                t(n).each(function (e, a) {
                                    ...
                                    f === i.meta.pages && f === t(u).last().data("page")
                                        ...
                                        : t(n).parent().show(),
                                    1 === i.meta.page
                                        ? (t(r).attr("disabled", !0).addClass("datatable-pager-link-disabled"),
                                          t(s).attr("disabled", !0).addClass("datatable-pager-link-disabled"))
                                        : (t(r).removeAttr("disabled").removeClass("datatable-pager-link-disabled"),
                                          t(s).removeAttr("disabled").removeClass("datatable-pager-link-disabled")),
                                    i.meta.page === i.meta.pages
                                        ? (t(d).attr("disabled", !0).addClass("datatable-pager-link-disabled"),
                                          t(c).attr("disabled", !0).addClass("datatable-pager-link-disabled"))
                                        : (t(d).removeAttr("disabled").removeClass("datatable-pager-link-disabled"),
                        ...
                        setTimeout(function () {
                            t(o.table).find(".datatable-cell").show(),
                                t(o.tableBody).each(function () {
                                    for (
                                        var a = 0;
                                        t(this)[0].offsetWidth < t(this)[0].scrollWidth && a < i.columns.length;
                                        ...
                                        t(o.table)
                                            ...
                                            .each(function (a) {
                                                var n = t(this)
                                                    .find(".datatable-cell:not(:hidden):not([data-autohide-disabled])")
                                                    .last();
                                                t(n).hide(), (e = !0);
                                            }),
                                            a++;
                                    ...
                                    t(o.tableBody)
                                        ...
                                        .each(function () {
                                            0 === t(this).find(".datatable-toggle-detail").length &&
                                                ...
                                                0 === t(o.tableHead).find(".datatable-toggle-detail").length
                                                    ? (t(o.tableHead)
                                                          .find(".datatable-row")
                                                          .first()
                                                          .prepend(
                                                    ...
                                                    : t(o.tableHead).find(".datatable-toggle-detail").find("span");
                                        });
                        }),
                    ...
                    setAutoColumns: function () {
                        l.getOption("data.autoColumns") &&
                            ...
                            l.getOption("layout.footer") &&
                                (t(o.tableFoot).find(".datatable-row").remove(), l.setHeadTitle(o.tableFoot)));
                    },
                    isLocked: function () {
                        ...
                        var e = {
                            ...
                            sortClick: function (n) {
                                ...
                                if (
                                    ...
                                    (t(o.tableHead).find("th").removeClass("datatable-cell-sorted"),
                    ...
                    extendObj: function (t, e, a) {
                        ...
                        return (
                            (function t(e) {
                                var o = n[i++];
                                void 0 !== e[o] && null !== e[o]
                                    ? "object" != typeof e[o] && "function" != typeof e[o] && (e[o] = {})
                                    : (e[o] = {}),
                    ...
                    rowEvenOdd: function () {
                        t(o.tableBody).find(".datatable-row").removeClass("datatable-row-even"),
                            t(o.wrap).hasClass("datatable-subtable")
                                ...
                                : t(o.tableBody).find(".datatable-row:nth-child(even)").addClass("datatable-row-even");
                    },
                    timer: 0,
                    redraw: function () {
                        return (
                    ...
                    getRecord: function (e) {
                        return (
                            void 0 === o.tableBody && (o.tableBody = t(o.table).children("tbody")),
                            t(o.tableBody)
                    ...
                    getColumn: function (e) {
                        return (
                            l.setSelectedRecords(), (o.API.value = t(o.API.record).find('[data-field="' + e + '"]')), o
                        );
                    },
                    destroy: function () {
                        ...
                        return (
                            t(o).replaceWith(e), t((o = e)).trigger("datatable-on-destroy"), (l.isInit = !1), (e = null)
                        );
                    },
                    sort: function (e, a) {
                    ...
                    setActive: function (e) {
                        "string" == typeof e &&
                            (e = t(o.tableBody).find('.checkbox-single > [type="checkbox"][value="' + e + '"]')),
                            t(e).prop("checked", !0);
                        var a = [];
                            ...
                            (n = function () {
                                ...
                                "object" == typeof a &&
                                    ...
                                    o.setDataSourceParam(
                                        "pagination",
                                        Object.assign({}, o.getDataSourceParam("pagination"), { page: 1 })
                                    ),
                                    i.data.serverFiltering || l.localDataUpdate(),
                                    l.dataRender("search");
                            }),
                    ...
                    getPageSize: function () {
                        return (
                            t(o.table).siblings(".datatable-pager").last().find("select.datatable-pager-size").val() ||
                            10
                        );
                    },
                    ...
                    rows: function (e) {
                        return (
                            l.isLocked()
                                ...
                                : (l.nodeTr = l.recentNode = t(o.tableBody).find(e).filter(".datatable-row")),
                            o
                        );
                    },
                    column: function (e) {
                    ...
                    columns: function (e) {
                        ...
                        return (
                            n.length > 0
                                ...
                                : (l.nodeCols = l.recentNode = t(a).find(e).filter(".datatable-cell")),
                            o
                        );
                    },
                    cell: function (e) {
                    ...
                    remove: function () {
                        return (
                            t(l.nodeTr.length) && l.nodeTr === l.recentNode && t(l.nodeTr).remove(), l.layoutUpdate(), o
                        );
                    },
                    visible: function (e) {
                        if (t(l.recentNode.length)) {
                            ...
                            e
                                ? (l.recentNode === l.nodeCols && delete i.columns[n].visible, t(l.recentNode).show())
                                : (l.recentNode === l.nodeCols && l.setOption("columns." + n + ".visible", !1),
                                  t(l.recentNode).hide()),
                                l.columnHide(),
                                l.redraw();
                        }
                ...
                if (
                    ...
                    if ("string" == typeof i) {
                        ...
                        void 0 !== (o = t(this).data(e)) &&
                            ((i = o.options), l[r].apply(this, Array.prototype.slice.call(arguments, 1)));
                    } else
                        o.data(e) ||
            ...
            (t.fn.KTDatatable.checkbox = function (e, a) {
                var n = {
                        ...
                        t(e.tableHead)
                            ...
                            t(e.tableBody)
                                ...
                                .click(function (i) {
                                    var o = t(this).val();
                                    t(this).is(":checked")
                                        ? (n.selectedRows.push(o), (n.unselectedRows = n.remove(n.unselectedRows, o)))
                                        : (n.unselectedRows.push(o), (n.selectedRows = n.remove(n.selectedRows, o))),
                                        !a.vars.requestIds &&
                    ...
                    initSelect: function () {
                        n.selectedAllRows && a.vars.requestIds
                            ? (e.hasClass("datatable-error") ||
                                  t(e.tableHead).find('.checkbox-all > [type="checkbox"]').prop("checked", !0),
                              e.setActiveAll(!0),
                            ...
                            : (n.selectedRows.forEach(function (t) {
                              ...
                              !e.hasClass("datatable-error") &&
                                  t(e.tableBody).find('.checkbox-single > [type="checkbox"]').not(":checked").length <
                                      1 &&
                                  t(e.tableHead).find('.checkbox-all > [type="checkbox"]').prop("checked", !0));
                    },
                    ...
                    initVars: function () {
                        ...
                        void 0 !== t &&
                            ((n.selectedRows = t.selectedRows || []), (n.unselectedRows = t.unselectedRows || []));
                    },
                ...
                return (
                    ...
                    "object" == typeof a &&
                        ((a = t.extend(!0, {}, t.fn.KTDatatable.checkbox.default, a)), n.init.apply(this, [a])),
                    e
                );
            }),
            (t.fn.KTDatatable.checkbox.default = {
                vars: { selectedAllRows: "selectedAllRows", requestIds: "requestIds", rowIds: "meta.rowIds" },
            });
    })(jQuery);
var defaults = {
    layout: {
...
var KTLayoutAsideMenu = (function () {
    ...
    return {
        init: function (a) {
            var n, i;
            (t = KTUtil.getById(a)) &&
                ((i = "1" === KTUtil.attr(t, "data-menu-dropdown") ? "dropdown" : "accordion"),
    ...
    return {
        init: function (n) {
            (e = KTUtil.getById(n)),
                (t = KTUtil.getBody()),
                e &&
                    ((a = new KTToggle(e, { target: t, targetState: "aside-minimize", toggleState: "active" })).on(
                        "toggle",
                        function (t) {
    ...
    return {
        init: function (n) {
            ...
            ((e = KTUtil.getById(n)), (t = KTUtil.getBody()), e) &&
                ((l = KTUtil.hasClass(e, "aside-offcanvas-default") ? "aside-offcanvas-default" : "aside"),
                (a = new KTOffcanvas(e, {
                    baseClass: l,
                    overlay: !0,
...
var KTLayoutHeaderTopbar = (function () {
    ...
    return {
        init: function (e) {
            (t = KTUtil.getById(e)) &&
                new KTToggle(t, { target: KTUtil.getBody(), targetState: "topbar-mobile-on", toggleState: "active" });
        },
    ...
    var t,
        ...
        i = function () {
            ...
            return (
                ...
                a && ((n -= parseInt(KTUtil.css(a, "marginTop"))), (n -= parseInt(KTUtil.css(a, "marginBottom")))),
